...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const initialAnimElements = document.querySelectorAll('.grid-wrapper .tall, .grid-wrapper .box, .grid-wrapper .big, .grid-wrapper .wide2,  .grid-wrapper .wide , .grid-wrapper .big-2');
        ...
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                const isInitialAnimElement = entry.target.classList.contains('tall') || 
                                          ...
                                          entry.target.classList.contains('big-2') ||
                                          entry.target.classList.contains('wide') ||
